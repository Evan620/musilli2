-- Real-time Analytics & Monitoring Migration
...
-- 5. Create real-time dashboard stats view
...
-- 8. Create triggers for automatic activity tracking

-- Trigger to track user logins
CREATE OR REPLACE FUNCTION track_login_activity() RETURNS TRIGGER AS $$
BEGIN
...
-- Note: This trigger would be applied to auth.sessions table if accessible
-- For now, we'll track logins manually in the application
...
-- 11. Insert initial analytics data
...
-- 12. Create sample analytics data for testing
DO $$
BEGIN

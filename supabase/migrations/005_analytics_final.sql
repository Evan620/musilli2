-- Real-time Analytics & Monitoring Migration (FINAL CORRECTED VERSION)
...
-- 11. Create sample analytics data for testing (FIXED - proper DATE casting)
DO $$
DECLARE
  sample_date DATE;
BEGIN
  ...
  FOR i IN 0..6 LOOP
    sample_date := (CURRENT_DATE - INTERVAL '1 day' * i)::DATE;
